      ...
      <div className='flex mt-16 md:flex-row flex-col justify-between items-center gap-8'>
        ...
        <div className="social flex items-center md:gap-3 gap-6">
          {socialMedia.map((profile, key)=>(
            ...
            <div key={profile.id} className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-150 bg-opacity-75 bg-[#f9fafb] rounded-lg border border-black-300'>
