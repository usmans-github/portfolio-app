  ...
  return (
    <div className='pb-20 pt-36 '>
      ...
      <div className="flex justify-left relative my-20 z-10">
        <div className='max-w[89vw] md:max-w-2xl lg:max-w-[55vw] flex lg:ml-24 flex-col items-center justify-between'>

        <h1 style={{lineHeight:"1.2em"}} className='leading-[24px] tracking-tight  text-[40px] md:text-4xl lg:text-5xl text-gray-800 dark:text-white font-bold'>Next.js & <span className='text-purple'> React developer</span>, and AI enthusiast.</h1>
